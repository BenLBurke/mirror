...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Focus on the Temple."],
			morning: ["Who will you serve today?", "Enjoy your day!", "How was your sleep?"],
			afternoon: ["You got this!", "Make sure you eat lunch today", "Looking good today!"],
			evening: ["Keep it up!", "You deserve some rest.", "Nice work today"],
